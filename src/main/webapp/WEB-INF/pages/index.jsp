            ...
            <div class="row m-2">
                <div class="col-sm-12">
                    <a class="btn btn-primary text-light"
                       href="topic">Редактировать темы</a>
                </div>
            </div>
            <div class="row m-2">
                <div class="col-sm-12">
                    <a class="btn btn-primary text-light">Редактировать тесты</a>
                </div>
            </div>
            <div class="row m-2">
                <div class="col-sm-12">
                    <a class="btn btn-primary text-light">Редактировать вопросы/ответы</a>
                </div>
            </div>
            <div class="row m-2">
                <div class="col-sm-12">
