...
<div class="container">
    ...
    <div class="row m-2 align-items-center">
        ...
        <div class="col-sm-12 col-md-7 pl-4">
            <label>How do you want to login?</label>
            <div class="row m-2">
                <div class="col-sm-12">
                    <a href="#" class="btn btn-primary text-light">Login as Admin</a>
                </div>
            </div>
            <div class="row m-2">
                <div class="col-sm-12">
                    <a href="#" class="btn btn-primary text-light">Login as Tutor</a>
                </div>
            </div>
            <div class="row m-2">
                <div class="col-sm-12">
                    <a href="#" class="btn btn-primary text-light">Login as User</a>
                </div>
            </div>
        </div>
    </div>
